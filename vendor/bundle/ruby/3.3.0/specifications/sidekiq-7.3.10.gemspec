...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<redis-client>.freeze, [">= 0.23.0".freeze, "< 1".freeze])
  s.add_runtime_dependency(%q<connection_pool>.freeze, [">= 2.3.0".freeze, "< 3".freeze])
